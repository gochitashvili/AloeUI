...
<Steps>
  <Step>
    ...
    ```package-install
    npx shadcn@latest add "@aloeui/data-table"
    ```
  </Step>
  <Step>
  ...
  <Step>
    ...
    ```package-install
    npx shadcn@latest add "@aloeui/data-table-sort-list"
    ```

    [`DataTableFilterList`](#datatablefilterlist):

    ```package-install
    npx shadcn@latest add "@aloeui/data-table-filter-list"
    ```

    [`DataTableFilterMenu`](#datatablefiltermenu):

    ```package-install
    npx shadcn@latest add "@aloeui/data-table-filter-menu"
    ```
  </Step>
  <Step>
