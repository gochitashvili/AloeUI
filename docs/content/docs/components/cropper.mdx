...
```package-install
npx shadcn@latest add @aloeui/cropper
...
A cropper integrated with the [FileUpload](https://aloeui.com/docs/components/file-upload) component for uploading and cropping images.
